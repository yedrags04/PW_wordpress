...
final class ELEMENTOR_AIOS_SLIDER {
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_AIOS_SLIDER ) );
...
// Instantiate ELEMENTOR_AIOS_SLIDER.
new ELEMENTOR_AIOS_SLIDER();
